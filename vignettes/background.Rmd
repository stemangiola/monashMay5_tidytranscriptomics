---
title: "Background knowledge for the Tidy Transcriptomics talk"
author:
...
vignette: >
  %\VignetteIndexEntry{Background knowledge for the Tidy Transcriptomics talk}
...
Schedule can be found [here](https://stemangiola.github.io/monashMay5_tidytranscriptomics/index.html#time-outline).  
<br>
...
* Variant analysis  
<br>
Topics in bold we will see in this talk
<br>
<br>
...
If you want to follow along and run the code on your own computer, see instructions [here](https://stemangiola.github.io/monashMay5_tidytranscriptomics/index.html#talk-package-installation). Alternatively, you can view the material at the talk webpage [here](https://stemangiola.github.io/monashMay5_tidytranscriptomics/articles/tidytranscriptomics.html). 
